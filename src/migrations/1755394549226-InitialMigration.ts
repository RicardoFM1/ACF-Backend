...
export class InitialMigration1755394549226 implements MigrationInterface {
    name = 'InitialMigration1755394549226'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "campos" ADD CONSTRAINT "FK_cd50d135e86e70e28280bfdbc90" FOREIGN KEY ("horariosId") REFERENCES "horarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
