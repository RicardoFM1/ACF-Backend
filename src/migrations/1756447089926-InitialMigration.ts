...
export class InitialMigration1756447089926 implements MigrationInterface {
    name = 'InitialMigration1756447089926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "campos" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "endereco" character varying NOT NULL, "descricao" character varying NOT NULL, "imagem" character varying NOT NULL, "status" character varying NOT NULL, "valor" integer NOT NULL, CONSTRAINT "PK_354272e954a46096a9392ee3c98" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "horarios" ("id" SERIAL NOT NULL, "dia_da_semana" character varying NOT NULL, "status" character varying NOT NULL, "horario_inicial" character varying NOT NULL, "horario_final" character varying NOT NULL, "camposId" integer, CONSTRAINT "PK_c69b602fc8441125f1310a4858d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "agendamentos" ("id" SERIAL NOT NULL, "horario" character varying NOT NULL, "status" character varying NOT NULL, "data" character varying NOT NULL, "camposId" integer, "usuariosId" integer, CONSTRAINT "PK_3890b7448ebc7efdfd1d43bf0c7" PRIMARY KEY ("id"))`);
